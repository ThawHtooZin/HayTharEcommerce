...
const socialLinks = [
  { label: 'Instagram', href: import.meta.env.VITE_SOCIAL_INSTAGRAM || '#', icon: Share2 },
  { label: 'Facebook', href: import.meta.env.VITE_SOCIAL_FACEBOOK || '#', icon: MessageCircle },
  { label: 'TikTok', href: import.meta.env.VITE_SOCIAL_TIKTOK || '#', icon: Video },
]
      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 lg:grid-cols-4 lg:px-8">
        <div>
          ...
          <p className="mt-3 text-sm leading-relaxed text-plum/70">
            Curated kawaii goods, trendy streetwear and the softest accessories.
          </p>
        </div>
